...
window.IMS_DATA = {
  ...
  publications: [
    ...
    },
    {
          ...
          "author": "Institute for Saharan Margins",
          "summary": "Southern Libya caught between Khalifa Haftar's Libyan National Army and Mahamat Wardougou's Operations Chamber for the Liberation of Southern Libya: what the attack on the Erendeguè post reveals about the Chad-Libya lock on the Fezzan, the trans-Saharan shadow economy and the resupply of the RSF in Darfur.",
          "excerpt": "On 12 July 2026, a Tubu guerrilla force attacked the Erendeguè border post, held by Haftar's forces at the gateway to Niger. Behind the clash: control of the Libya-Chad-Niger triangle, the criminal economy of the Fezzan and the Libyan relay in supplying the Rapid Support Forces.",
          "tags": [
                "Libya",
                "Fezzan",
                "Haftar",
          ...
          "body": [
                "<div style=\"background:#17284a;color:#eef1f6;border-left:5px solid #c1440e;border-radius:6px;padding:1.4rem 1.5rem;margin:0 0 1.8rem;\"><span style=\"display:block;font-size:.7rem;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#c9a86a;margin-bottom:.6rem;\">Executive summary</span><p style=\"margin:0;font-family:Georgia,serif;font-size:1.05rem;line-height:1.6;color:#eef1f6;font-weight:600;\">The lock that Khalifa Haftar and N'Djamena believed they had placed on the Fezzan is giving way. A Tubu guerrilla force, the <strong style=\"color:#fff;\">Operations Chamber for the Liberation of Southern Libya</strong> (COLSL), is harassing border posts held by the Libyan National Army and the Chadian contingents alongside it. The stated aim is the liberation of the Fezzan; the real one is control of the Libya-Chad-Niger triangle and of the <strong style=\"color:#fff;\">trans-Saharan shadow economy</strong> that runs through it — fuel, weapons, gold, migrants. In the background, southern Libya has taken over from Chadian airports in supplying the Rapid Support Forces in Darfur.</p></div>",
                "<p>On 12 July 2026, an armed group led by Mahamat Wardougou attacked the Erendeguè border post, at the gateway to Niger, held by forces of the Libyan National Army. Field sources report that the post was taken. If confirmed, it flatly contradicts the messaging of recent months, in which Khalifa Haftar and the Chadian government presented southern Libya as locked down.</p>",
                "<div style=\"background:#faf6ee;border:1px solid #e3d7bf;border-left:4px solid #c1440e;border-radius:6px;padding:1rem 1.2rem;margin:1.6rem 0;font-size:.93rem;color:#5b5346;\"><strong style=\"color:#9a350a;\">Confidence level.</strong> The capture of the Erendeguè post rests at this stage on anonymous field sources, not corroborated by an independent one. We treat it as probable, not as established fact. Later developments may require a correction to this note, which will be flagged on this page.</div>",
                "<h2>1. What the attack reveals</h2>",
                "<p>Erendeguè is not an isolated target. Since the start of the year, fighting has concentrated on the posts of Toum and Wadi Bougrara and the Salvador pass, before extending to the Arindiga gateway and the Al-Wigh military base. It is the crossing points, not the towns, that are being fought over. The map of the conflict follows the map of the convoys.</p>",
                "<p>What matters is less the military value of these posts than what their loss means. A conventional force with air assets and mercenaries is losing positions to a guerrilla force of a few hundred men. The balance of power on paper says nothing about the balance of power on the ground.</p>",
                "<h2>2. The Libyan National Army: strength and limits</h2>",
                "<p>The LAAF emerged in 2014 from the disorder that followed the fall of Muammar Gaddafi, at a time when militias set the rules. From Benghazi, Khalifa Haftar launched Operation « Dignity » against Islamist and jihadist groups in the east. The coalition brought together former Gaddafi-era officers, tribal militias and armed groups with little in common.</p>",
                "<p>The stated objective is to secure the country and unify it under a single military command. The conflict with Tripoli is in fact about political power and oil revenue. Haftar casts the Government of National Unity as hostage to extremist militias; Tripoli sees in him a candidate for military dictatorship. The confrontation has long been internationalised: Russia, the United Arab Emirates and Egypt on one side, Turkey on the other.</p>",
                "<div style=\"background:#fff;border:1px solid #e3d7bf;border-top:4px solid #c1440e;border-radius:6px;padding:1.1rem 1.3rem;margin:1.8rem 0;\"><div style=\"font-size:.72rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#9a350a;margin-bottom:.7rem;\">Key markers</div><ul style=\"list-style:none;margin:0;padding:0;font-size:.92rem;color:#333;\"><li style=\"padding:.32rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:92px;\">2014</strong> the LAAF are formed and Operation « Dignity » is launched from Benghazi</li><li style=\"padding:.32rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:92px;\">25,000-80,000</strong> personnel on available estimates, foreign mercenaries included</li><li style=\"padding:.32rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:92px;\">2021</strong> FACT, setting out from the Fezzan, reaches Kanem: Idriss Déby Itno is killed</li><li style=\"padding:.32rem 0;\"><strong style=\"color:#17284a;display:inline-block;min-width:92px;\">12 Jul 2026</strong> attack on the Erendeguè post, at the gateway to Niger</li></ul></div>",
                "<p>Troop numbers are poorly known. Available estimates range from 25,000 to 80,000, a spread wide enough to serve as a reminder that these are orders of magnitude rather than counts. They include foreign mercenaries: Russians from the Wagner apparatus, Syrians, Chadians, Sudanese. The military core matters less than the web of tribal and militia alliances around it, and that web comes apart as quickly as it forms.</p>",
                "<h3 style=\"font-size:1.05rem;color:#17284a;margin:1.4rem 0 .5rem;\">A Chadian trajectory</h3>",
                "<p>Haftar's biography explains much about his relationship to the south. A senior officer under Gaddafi, he took part in the 1969 coup. He commanded Libyan forces during the Chad war of the 1980s, the one known as the Toyota War. Captured by the Chadians, he was disowned by Gaddafi. He then turned against his mentor, built a CIA-backed rebellion, and spent some twenty years in exile in the United States. He returned in 2011 to take part in the regime's fall. A man who lost a war in Chad is back forty years later holding the Chadian border with N'Djamena's support.</p>",
                "<h2>3. The COLSL: a Tubu guerrilla in the Fezzan</h2>",
                "<p>The Operations Chamber for the Liberation of Southern Libya, sometimes associated with the militias known as the « Revolutionaries of the South », formed against LAAF dominance in the Fezzan. It brings together local forces seeking to preserve their autonomy against offensives from the east and to weigh on the running of a desert territory.</p>",
                "<p>This is not a conventional army. It is a mobile guerrilla force, seasoned in desert warfare, made up mainly of Tubu fighters and militia alliances of convenience. Its strength lies not in numbers but in knowledge of the terrain and a capacity for harassment that air support does not neutralise.</p>",
                "<p>Mahamat Wardougou, nicknamed « Kochi », is a military leader from the Tubu community, which straddles Libya, Chad and Niger. He is an ally of convenience for Tripoli, from which he receives financial and logistical backing. For the western authorities, supporting Tubu commanders is an asymmetric strategy: harass Haftar from the south, cut his supply lines, contest his control without committing their own forces. Wardougou, for his part, relies on Tubu solidarity rather than on that alliance.</p>",
                "<h2>4. The Fezzan: what is really at stake</h2>",
                "<p>The « liberation » of the Fezzan is the stated objective. The real stake is control of the Libya-Chad-Niger border triangle and the routes crossing it. Fuel, arms and drug smuggling, clandestine gold mining, migrant trafficking: the Fezzan is a hub of the trans-Saharan criminal economy, and that economy has changed scale.</p>",
                "<p>What were informal circuits have become a heavy corridor, held by the LAAF. It is this corridor that the COLSL attacks, burning convoys and striking the posts that protect them. A conflict over revenue as much as over territory.</p>",
                "<h2>5. The Libyan relay in supplying the RSF</h2>",
                "<p>Chadian airports have been implicated in fuelling the Sudanese conflict, with converging evidence of logistics benefiting the Rapid Support Forces out of N'Djamena, Amdjarass and Abéché. The Fezzan complements that setup and, at times, substitutes for it. Evidence links southern Libya to the areas of Darfur held by the RSF.</p>",
                "<p>This is precisely where the COLSL acts. Preventing the resupply of the RSF through southern Libya is one of its declared objectives, and it targets N'Djamena as much as Benghazi. The logic reaches beyond the Fezzan: it connects Sudan's war to the Chadian margins and eastern Niger.</p>",
                "<p>Haftar has long maintained relations with General Mohamed Hamdan Dagalo's RSF. Sudanese fighters have served as mercenaries in his ranks. In the current conflict, he is accused of having supplied the RSF with weapons and fuel, with presumed Russian backing. Eastern Libya functions as a logistical hub for the conflicts of the region.</p>",
                "<h2>6. State factionalism on the margins</h2>",
                "<p>For years N'Djamena has run a border influence strategy built on bilateral defence agreements and on joint forces with Libya, Sudan and the Central African Republic. In practice these forces operate as militias. The Chad-Libya joint force is commanded by General Korè Dadi, a first cousin of the head of state. The chain of command follows kinship as much as rank.</p>",
                "<p>The alliance with Haftar is aimed first at containing the Chadian armed groups established in southern Libya and eastern Niger, foremost among them FACT — the very group that, setting out from the Fezzan in 2021, cost President Idriss Déby Itno his life — and the CCMSR. Several Chadian contingents are fighting alongside the LAAF against the COLSL. That exposure has a price: it turns Libyan adversaries into adversaries of Chad.</p>",
                "<p>In early 2026, heavy clashes in southern Libya, notably near Gatroun, ended in setbacks for the Chad-Libya axis. Chadian troops had already clashed with Wardougou's men on the Chad-Niger border, where the COLSL and several Chadian armed groups maintain rear bases.</p>",
                "<h2>7. Points to watch</h2>",
                "<p><strong>Holding the border posts.</strong> Erendeguè, Toum, Salvador, Al-Wigh: the LAAF's ability to retake and hold these points will show whether the loss is incidental or structural. A post retaken and lost again is an admission of weakness.</p>",
                "<p><strong>Chadian exposure.</strong> Every contingent committed to the north adds to the number of fronts N'Djamena must hold at once, while the eastern border already absorbs Sudanese pressure. The factionalism of the joint forces weakens command as much as it concentrates it.</p>",
                "<p><strong>The Algerian position.</strong> Algiers takes a dim view of the Haftar-Emirates-Russia axis settling on its southern border. Algerian goodwill towards the COLSL is plausible without being established; it would change the scale of the balance of power.</p>",
                "<p><strong>RSF resupply.</strong> If the COLSL manages to interrupt the flows from the Fezzan for any length of time, the effect will register in Darfur before it registers in Libya.</p>",
                "<h2>8. Sources and method</h2>",
                "<div style=\"font-size:.9rem;color:#444;background:#faf6ee;border:1px solid #e3d7bf;border-radius:6px;padding:.9rem 1.1rem;margin:1.2rem 0;\">This note combines field reporting from the Institute's network of contacts in the Libya-Chad-Niger triangle with open sources and existing work on the political economy of the Fezzan.</div><ul style=\"list-style:none;margin:.5rem 0 0;padding:0;font-size:.85rem;color:#5b5346;\"><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">IMS — « Strategic analysis: the risk of the Saharan quadrangle blowing up (Libya-Chad-Sudan-CAR) », Cahiers du Tibesti, 15 July 2026.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">IMS — « Tiné: Sudan's War Spills Its Humanitarian Catastrophe onto Chad », Cahiers du Tibesti, 12 July 2026.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">IMS — Field reporting, border posts of the Fezzan and eastern Niger, June-July 2026 (contacts protected).</li><li style=\"padding:.3rem 0;\">Note on spelling: renderings of the COLSL leader's name vary across sources (Mahamat Wardougou, Mohamed Wourdougou, nickname « Kochi »). The form used here is the one most often used by our contacts.</li></ul>"
          ]
    },
    {
