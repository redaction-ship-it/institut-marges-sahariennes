...
window.IMS_DATA = {
  ...
  publications: [
    ...
    },
    {
          ...
          "author": "Institute for Saharan Margins",
          "summary": "The Fezzan in insurgency since January 2026: what the 12 July attack on Al-Wigh reveals about the limits of Libyan National Army control, and why the UN Panel of Experts report places the Chad-Libya joint force in direct contact with the Rapid Support Forces' supply chain.",
          "excerpt": "Since January 2026, the Operations Chamber for the Liberation of the South has contested LAAF control over the Fezzan. The UN Panel of Experts report on Libya establishes that the Subul Al-Salam battalion supplies the RSF in Sudan — the same battalion to which Saddam Haftar assigned operations of the joint force with the Chadian army.",
          "tags": [
                "Libya",
                "Fezzan",
                "Haftar",
          ...
          "body": [
                "<div style=\"background:#17284a;color:#eef1f6;border-left:5px solid #c1440e;border-radius:6px;padding:1.4rem 1.5rem;margin:0 0 1.8rem;\"><span style=\"display:block;font-size:.7rem;font-weight:800;letter-spacing:.14em;text-transform:uppercase;color:#c9a86a;margin-bottom:.6rem;\">Executive summary</span><p style=\"margin:0;font-family:Georgia,serif;font-size:1.05rem;line-height:1.6;color:#eef1f6;font-weight:600;\">Since January 2026, an insurgency led by a Tubu commander has contested the Libyan National Army's control over the Fezzan. The 12 July attack on the Al-Wigh base showed that control to be thinner than advertised, without overturning the balance of forces. The most consequential point is not military: the final report of the UN Panel of Experts on Libya establishes that the <strong style=\\\"color:#fff;\\\">Subul Al-Salam battalion</strong> runs the supply chains feeding the Rapid Support Forces in Sudan. It is that same battalion to which Saddam Haftar assigned operations of the <strong style=\\\"color:#fff;\\\">joint border force with Chad</strong>. N'Djamena has therefore attached its northern border apparatus to the unit the UN identifies as a link in RSF resupply.</p></div>",
                "<p>On 12 July 2026, the Operations Chamber for the Liberation of the South launched an attack codenamed « Arendiga », after the gateway leading to the Al-Wigh air base in Libya's far south, near the Nigerien and Chadian borders. The operation targeted a military checkpoint on the road to the base, where Russian Africa Corps personnel are also stationed. The attackers filmed the assault and claimed the capture of some fifteen LAAF soldiers along with rocket launchers, armed vehicles and an anti-aircraft jamming system. <strong>The base itself did not fall.</strong></p>",
                "<div style=\"background:#faf6ee;border:1px solid #e3d7bf;border-left:4px solid #c1440e;border-radius:6px;padding:1rem 1.2rem;margin:1.6rem 0;font-size:.93rem;color:#5b5346;\"><strong style=\"color:#9a350a;\">Reliability note.</strong> In this theatre, images and casualty counts come almost exclusively from the belligerents or from aligned media. This note distinguishes three levels: facts <strong>established</strong> by independent or institutional sources, <strong>probable</strong> facts corroborated by several non-independent sources, and unverified <strong>claims</strong> by one side. Every sensitive assertion is qualified in the text.</div>",
                "<h2>1. A sequence, not an incident</h2>",
                "<p>The 12 July attack closes a half-year of fighting; it does not open it. Since late January 2026, the Fezzan has seen repeated clashes between the LAAF and the COLSL. The timeline matters more than the episode: it shows an insurgency that persists, that learns, and that picks its moments.</p>",
                "<div style=\"background:#fff;border:1px solid #e3d7bf;border-top:4px solid #17284a;border-radius:6px;padding:1.2rem 1.4rem;margin:1.8rem 0;\"><div style=\"font-size:.72rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#9a350a;margin-bottom:.8rem;\">Timeline of the sequence</div><ul style=\"list-style:none;margin:0;padding:0;font-size:.92rem;color:#333;\"><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">Nov. 2025</strong> Haftar's command announces a joint force with the Chadian army, placed under Saddam Haftar's supervision, who assigns its operations to the border guard and desert patrol administration linked to the Subul Al-Salam battalion.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">Jan. 2026</strong> The Operations Chamber for the Liberation of the South (COLSL) is created. First clashes at three border posts: Toum, Wadi Bougrara, the Salvador pass. The COLSL announces the closure of the borders with Sudan, Chad, Niger and Algeria.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">Feb. 2026</strong> A Chadian column deployed alongside the LAAF is ambushed near the Niger border: around ten Chadian dead, several soldiers probably captured. The LAAF pursues the attackers into Nigerien territory and uses drones.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">24 Mar. 2026</strong> Publication of the final report of the UN Panel of Experts on Libya, covering October 2024 to February 2026.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">7 May 2026</strong> A wave of decree appointments reorganises the Chad-Libya joint border security force.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">12 Jul. 2026</strong> Operation « Arendiga » against a checkpoint leading to the Al-Wigh air base, while the eastern and western chiefs of staff meet at Sirte under American impetus.</li><li style=\"padding:.4rem 0;border-bottom:1px dashed #e3d7bf;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">14 Jul. 2026</strong> LAAF counter-offensive, operation « Scorpion Hunt ». Saddam Haftar is dispatched to the south and convenes the generals of every sector.</li><li style=\"padding:.4rem 0;\"><strong style=\"color:#17284a;display:inline-block;min-width:110px;\">16-20 Jul. 2026</strong> A war of images: the LAAF releases its own prisoners, presented as Chadian, Nigerien and Sudanese; the COLSL claims to have burned trucks bound for the RSF. Neither claim is verified.</li></ul></div>",
                "<p>The choice of date deserves attention. On 12 July, the eastern and western Libyan chiefs of staff were meeting at Sirte under American impetus, as part of the initiative led by envoy Massad Boulos. The COLSL explicitly rejects that power-sharing arrangement between Haftar and Dbeibah and demands elections. The attack is not only military: it targets a political process.</p>",
                "<h2>2. The COLSL: what is known, what is not</h2>",
                "<p>The Operations Chamber for the Liberation of the South was formed in January 2026 out of a rejection of the Haftar clan's grip on the Fezzan. It is led by a Tubu commander whom sources name variously as Mohamed or Mahamat Wardougou, and whose full name appears as Baraka Wardako al Tabawi. From its creation it announced the closure of the borders with Sudan, Chad, Niger and Algeria, and warned against any attempt to force the passage towards Sudan.</p>",
                "<p>Its strength is unknown. So is its funding, beyond backing from Tripoli that the western authorities barely conceal: the Grand Mufti Sadek al-Gharian publicly criticised the Dbeibah government for not supporting Wardougou generously enough. That gap is itself a data point. A movement whose numbers and finances remain unknown after six months is a movement whose staying power remains undetermined.</p>",
                "<p>Wardougou, for his part, rejects the charge of being a proxy. He says he has no Chadian mercenaries in his ranks and is « nobody's agent ». He justifies his mobilisation by living conditions in the south and by the informal taxes levied on every truck heading out to neighbouring countries, whose proceeds he says he cannot trace. His group launched an operation named « Quicksand » against those collection points. The grievance is therefore as fiscal as it is political.</p>",
                "<h3 style=\"font-size:1.05rem;color:#17284a;margin:1.4rem 0 .5rem;\">The disavowal that changes the reading</h3>",
                "<p>The most significant element of the sequence is not military. Notables and sheikhs of the Tubu tribe of Qatroun publicly distanced themselves from Wardougou, stating that he does not speak for their community and acts on his own responsibility. A Tuareg tribe and a Tubu tribe have moreover issued communiqués supporting the LAAF.</p>",
                "<p>That disavowal undercuts the ethnic reading of the conflict, the one Haftar's supporters promote by casting the confrontation as a Tubu affair against the Libyan state. It also weakens the COLSL: an insurgency that loses its local social base more often dies out than takes root. It is the most useful indicator to follow in the coming weeks.</p>",
                "<h2>3. The LAAF under the panel of experts' scrutiny</h2>",
                "<p>The final report of the UN Panel of Experts on Libya, published on 24 March 2026 and covering October 2024 to February 2026, does not deal with the COLSL. It deals with what the COLSL says it is fighting, and its findings are severe.</p>",
                "<p>The panel links Khalifa Haftar's command and his son Saddam's forces to oil smuggling, capital flight, the management of financial and criminal networks, and the provision of weapons to Sudan's Rapid Support Forces. It notes that Saddam Haftar has consolidated control not only over the land forces but also over the external relations strategy and the economic interests of the apparatus. It also confirms a 2025 investigation involving the United Arab Emirates and a Libyan businessman close to Saddam Haftar.</p>",
                "<p>On the embargo the finding is blunt: it remains ineffective wherever member states themselves control the logistical flows and supply chains of armed actors. This is not a drafting problem but an enforcement one.</p>",
                "<h2>4. The documented link: Subul Al-Salam</h2>",
                "<p>This is where the two files meet, and the connection is the central point of this note.</p>",
                "<p>The panel of experts identifies the <strong>Subul Al-Salam battalion</strong>, commanded by Abdulrahman Hashim, as a key actor in the supply chain between Libya and Sudan. Between January 2025 and January 2026 the unit consolidated its control over the routes used to move fighters, weapons and equipment. In June 2025 it supported RSF operations by deploying units, providing fighters and facilitating access to fuel and spare vehicle parts, contributing to their advance on the Uwaynat area. The documented corridor starts at the ports of Benghazi and Tobruk and at eastern Libyan airports, then runs overland through Kufra and Al-Atrun into Sudan.</p>",
                "<p>Yet in November 2025, when Haftar's command announced the creation of a joint force with the Chadian army, it placed supervision under Saddam Haftar, who assigned field operations to the border guard and desert patrol administration — an administration linked to the Subul Al-Salam battalion.</p>",
                "<p><strong>N'Djamena has therefore attached its northern border apparatus to the unit the UN Panel of Experts identifies as a link in RSF resupply.</strong> This is no longer a field hypothesis; it is the convergence of two public sources independent of one another. Chad also hosts, at Amdjarass, the airport where UN experts counted twenty-four Ilyushin Il-76TD aircraft in 2024 and where investigations have tallied at least eighty-six flights from the Emirates, some fifty kilometres from the Sudanese border. Abu Dhabi denies this and presents the rotations as humanitarian.</p>",
                "<h2>5. A geographical nuance that matters</h2>",
                "<p>The COLSL claims to have intercepted and burned trucks bound for the RSF. No independent source has confirmed it, and both camps regularly recycle old footage. But there is a more interesting objection than simple caution.</p>",
                "<p>The documented corridor towards Darfur runs through Kufra and Al-Atrun, in south-eastern Libya. The COLSL operates in the Fezzan, in the south-west, on the posts of Toum, Salvador, Arindiga and Al-Wigh, facing Niger and Chad. These are two distinct geographies, separated by a thousand kilometres of desert. An organisation harassing south-western posts does not mechanically sever a supply chain that runs through the south-east.</p>",
                "<p>Two readings remain open. Either the COLSL overstates the reach of its action to build international legitimacy — blocking the resupply of a force accused of atrocities in Darfur is an argument that carries weight with foreign ministries. Or a secondary axis through the Fezzan exists that published investigations have not yet mapped. As things stand, the first reading is the more economical.</p>",
                "<h2>6. Chad is not a bystander</h2>",
                "<p>In February 2026, a Chadian military column deployed in a joint operation with Haftar's forces against Wardougou's men was ambushed near the Nigerien border. Around ten dead among the Chadians, several soldiers probably captured. The account comes from CEDPE, a research centre based in N'Djamena, and has been the subject of no official communication.</p>",
                "<p>N'Djamena is therefore a belligerent, not a regional trading partner. That casts light on the COLSL's warning against any traffic in weapons or goods towards Chad and Sudan: it is a warning addressed to an active adversary. It also casts light on the cost of the Chadian joint-force strategy, applied with Libya, Sudan and the Central African Republic. Each such arrangement turns a neighbour's quarrel into a national commitment, without public debate or published reckoning.</p>",
                "<p>On 7 May 2026, a wave of decree appointments reorganised the Chad-Libya joint border security force. The timing suggests an apparatus being reinforced after setbacks rather than one that is working.</p>",
                "<h2>7. Niger, the blind spot in the file</h2>",
                "<p>Niger appears in every description of this conflict and in no analysis of it. Al-Wigh sits close to its border. Wardougou regularly falls back into Nigerien territory. In February 2026 the LAAF pursued the attackers into Niger and used drones on that territory.</p>",
                "<p>Strikes carried out by a foreign non-state armed force on the soil of a third state, with no known public reaction from that state, are an anomaly. Either Niamey accepted them, or they were never brought to public attention. Either way, the question of what status the southern Libyan border holds for the Nigerien authorities remains open, and it conditions the regionalisation scenario.</p>",
                "<h2>8. The competing hypothesis</h2>",
                "<p>This note adopts a strategic reading: an insurgency backed by Tripoli contests Benghazi's control over the Fezzan and its rents. A more mundane reading deserves testing.</p>",
                "<p>The COLSL may be no more than a coalition of convenience born of a dispute over the division of informal taxes levied at crossing points, to which Tripoli lends opportunistic and revocable support. The Qatroun disavowal, the absence of any visible political structure and the fiscal nature of Wardougou's grievances all point that way. Three observations would invalidate the strategic reading adopted here: a withdrawal of Tripoli's support without the group collapsing, the fragmentation of the COLSL into competing factions on separate posts, or a local agreement on tax-sharing that ends the fighting without any political settlement.</p>",
                "<h2>9. Scenarios at six months</h2>",
                "<div style=\"overflow-x:auto;margin:1.6rem 0;\"><table style=\"width:100%;border-collapse:collapse;font-family:Segoe UI,Arial,sans-serif;font-size:.9rem;background:#fff;border:1px solid #e3d7bf;\"><caption style=\"caption-side:top;text-align:left;font-size:.72rem;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#9a350a;padding:0 0 .6rem;\">Three scenarios at six months</caption><thead><tr><th style=\"background:#17284a;color:#fff;text-align:left;padding:.65rem .8rem;font-size:.74rem;text-transform:uppercase;letter-spacing:.05em;\">Scenario</th><th style=\"background:#17284a;color:#fff;text-align:left;padding:.65rem .8rem;font-size:.74rem;text-transform:uppercase;letter-spacing:.05em;\">Content</th><th style=\"background:#17284a;color:#fff;text-align:left;padding:.65rem .8rem;font-size:.74rem;text-transform:uppercase;letter-spacing:.05em;\">Indicators to watch</th></tr></thead><tbody><tr><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;font-weight:800;color:#9a350a;\">Sustained harassment<br><span style=\"font-weight:400;font-size:.82rem;color:#5b5346;\">most likely</span></td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;\">The COLSL retains a capacity to disrupt without holding ground. The LAAF keeps the bases and periodically loses posts. Neither victory nor collapse.</td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;\">Frequency of attacks on posts; LAAF ability to retake within 72 hours; continuity of Tripoli funding.</td></tr><tr><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;font-weight:800;color:#9a350a;background:#faf6ee;\">Extinction through the social base</td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;background:#faf6ee;\">Tribal disavowal spreads, the COLSL shrinks to a core without local anchoring and turns predatory. The Qatroun disavowal makes this credible.</td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;background:#faf6ee;\">Further tribal communiqués; commanders defecting to the LAAF; targets shifting towards civilians and commercial convoys.</td></tr><tr><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;font-weight:800;color:#9a350a;\">Regionalisation<br><span style=\"font-weight:400;font-size:.82rem;color:#5b5346;\">tail risk</span></td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;\">LAAF pursuits into Nigerien territory recur, Niamey reacts, and the conflict stops being Libyan. Chadian commitment deepens on a second front.</td><td style=\"padding:.7rem .8rem;border-top:1px solid #e3d7bf;vertical-align:top;color:#2c2c2c;\">Official Nigerien protests; drone strikes south of the border; further Chadian losses; LAAF reinforcements towards Al-Wigh.</td></tr></tbody></table></div>",
                "<h2>10. Recommendations</h2>",
                "<div style=\"display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin:1.4rem 0;\"><div style=\"background:#fff;border:1px solid #e3d7bf;border-top:3px solid #17284a;border-radius:6px;padding:1rem 1.15rem;\"><h4 style=\"font-family:Segoe UI,Arial,sans-serif;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#17284a;margin:0 0 .45rem;\">Sanctions committee and panel of experts</h4><p style=\"margin:0;font-size:.92rem;color:#333;line-height:1.55;\">Document the status of the Chad-Libya joint force with respect to the arms embargo. A unit identified as a link in RSF resupply and simultaneously an official partner of a third state raises a compliance question the next report should settle.</p></div><div style=\"background:#fff;border:1px solid #e3d7bf;border-top:3px solid #17284a;border-radius:6px;padding:1rem 1.15rem;\"><h4 style=\"font-family:Segoe UI,Arial,sans-serif;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#17284a;margin:0 0 .45rem;\">Donors and defence cooperation</h4><p style=\"margin:0;font-size:.92rem;color:#333;line-height:1.55;\">Audit programmes supporting Chadian border security. The risk is not theoretical: technical or financial support may benefit an apparatus whose Libyan component is implicated by the UN.</p></div><div style=\"background:#fff;border:1px solid #e3d7bf;border-top:3px solid #17284a;border-radius:6px;padding:1rem 1.15rem;\"><h4 style=\"font-family:Segoe UI,Arial,sans-serif;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#17284a;margin:0 0 .45rem;\">European diplomatic services</h4><p style=\"margin:0;font-size:.92rem;color:#333;line-height:1.55;\">Treat the Fezzan as a migration file as much as a security one. Any reshuffling of control over border posts shifts migration routes towards the central Mediterranean, with a lag of a few months.</p></div><div style=\"background:#fff;border:1px solid #e3d7bf;border-top:3px solid #17284a;border-radius:6px;padding:1rem 1.15rem;\"><h4 style=\"font-family:Segoe UI,Arial,sans-serif;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#17284a;margin:0 0 .45rem;\">Exposed companies</h4><p style=\"margin:0;font-size:.92rem;color:#333;line-height:1.55;\">Reassess supply chains routed through eastern Libya. The panel of experts documents an entanglement of oil smuggling, financial networks and military command that bears on counterparty compliance.</p></div></div>",
                "<h2>11. Sources and method</h2>",
                "<div style=\"font-size:.9rem;color:#444;background:#faf6ee;border:1px solid #e3d7bf;border-radius:6px;padding:.9rem 1.1rem;margin:1.2rem 0;\">This note draws on the final report of the UN Panel of Experts on Libya, on published investigations into RSF supply chains, and on regional press monitoring of the January-July 2026 sequence. Belligerents' claims are flagged as such and do not carry the status of established fact.</div><ul style=\"list-style:none;margin:.5rem 0 0;padding:0;font-size:.85rem;color:#5b5346;\"><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">United Nations Security Council — Final report of the Panel of Experts established pursuant to resolution 1973 (2011) concerning Libya, published 24 March 2026, covering October 2024 - February 2026. See the summaries by <a href=\"https://libyaobserver.ly/news/un-panel-experts-report-details-libya-arms-embargo-violations-support-haftar\" style=\"color:#c1440e;\">The Libya Observer</a> and <a href=\"https://www.libya-analysis.com/blogs/panel-of-un-experts-reports-violations-of-libyas-arms-embargo\" style=\"color:#c1440e;\">Libya-Analysis</a>.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">UN Panel of Experts — RSF supply chains through Libya, the role of the Subul Al-Salam battalion and the Kufra - Al-Atrun axis: <a href=\"https://libyaobserver.ly/news/sudan-military-supplies-reaching-rapid-support-forces-through-locations-inside-libya\" style=\"color:#c1440e;\">The Libya Observer</a>, <a href=\"https://www.newarab.com/analysis/libya-link-how-haftar-helping-fuel-sudans-war\" style=\"color:#c1440e;\">The New Arab</a>, <a href=\"https://www.dabangasudan.org/en/all-news/article/new-report-rsf-training-camps-supply-routes-in-libya-fuelling-sudans-war-what-weve-uncovered-is-really-just-the-tip-of-the-iceberg\" style=\"color:#c1440e;\">Radio Dabanga</a>.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">Emirati airbridge to Amdjarass: <a href=\"https://sudantribune.com/article/299848\" style=\"color:#c1440e;\">Sudan Tribune</a> and <a href=\"https://www.newarab.com/news/un-report-ties-uae-sudan-war-chad-airbridge\" style=\"color:#c1440e;\">The New Arab</a>. The United Arab Emirates deny the allegations and describe these rotations as humanitarian flights.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">APAnews, 17 November 2025 — <a href=\"https://fr.apanews.net/security/libye-tchad-formation-dune-force-conjointe-sous-le-commandement-de-saddam-haftar/\" style=\"color:#c1440e;\">« Libya-Chad: a joint force under Saddam Haftar's orders »</a>, documenting the delegation of operations to the Subul Al-Salam battalion.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">RFI, reprinted by <a href=\"https://lematindalgerie.com/libye-un-groupe-arme-du-sud-marque-sa-volonte-de-harceler-les-troupes-du-clan-haftar/\" style=\"color:#c1440e;\">Le Matin d'Algérie</a>, 20 July 2026 — course of operation « Arendiga », the « Scorpion Hunt » response, Tripoli's backing and the Ukrainian hypothesis.</li><li style=\"padding:.3rem 0;border-bottom:1px dashed #e3d7bf;\">CEDPE (N'Djamena) — <a href=\"https://www.centrerecherche.com/Le-Fezzan-est-en-flammes-une-rebellion-affronte-le-marechal-Haftar-depuis-la-fin-janvier_a2246.html\" style=\"color:#c1440e;\">« The Fezzan is in flames »</a>, 15 July 2026, and <a href=\"https://www.centrerecherche.com/Libye-un-convoi-destine-aux-FSR-incendie-vraie-frappe-ou-guerre-de-l-image_a2283.html\" style=\"color:#c1440e;\">« A convoy bound for the RSF burned »</a>, 20 July 2026, for the Qatroun tribal disavowal and the February ambush.</li><li style=\"padding:.3rem 0;\">A note on names: the COLSL leader appears in sources as Mohamed Wardougou, Mahamat Wardougou or Baraka Wardako al Tabawi, nicknamed « Kochi ». The form used here follows the press sources. Likewise, command of the joint force on the Chadian side is attributed to Shérif Dadi Adam by open sources from November 2025; other spellings circulate and the kinship claims made locally could not be verified.</li></ul>"
          ]
    },
    {
